...
export default function Footer() {
  return (
    <footer className="bg-background border-t border-border text-foreground py-10 md:py-16">
        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12 text-left">
          <div className="text-left">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              The future of collaborative lending. Secure, compliant, and built for scale.
            </p>
            <div className="flex gap-4">
              <Link to="#" className="w-9 h-9 bg-muted hover:bg-muted/80 flex items-center justify-center transition-colors border border-border">
          ...
          <div className="col-span-1 md:col-span-3 grid grid-cols-3 gap-4 sm:gap-8 text-left">
            <div className="text-left">
            ...
            <div className="text-left">
              <h4 className="font-bold mb-4 text-foreground text-sm uppercase tracking-wider">Company</h4>
              <ul className="space-y-2 text-sm text-muted-foreground list-none p-0">
