...
function SheetHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex flex-col gap-1.5 p-4 !text-md", className)}
      {...props}
    />
  );
}
...
function SheetFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("mt-auto flex flex-col gap-2 p-4 !text-md", className)}
      {...props}
    />
  );
}
...
function SheetTitle({
  ...
  return (
    <SheetPrimitive.Title
      ...
      className={cn("text-foreground font-semibold !text-md", className)}
      {...props}
    />
  );
}
...
function SheetDescription({
  ...
  return (
    <SheetPrimitive.Description
      ...
      className={cn("text-muted-foreground text-sm !text-md", className)}
      {...props}
    />
  );
}
