...
export default function BorrowerLayout({ 
  ...
  const navItems = [
    ...
    { name: "Browse Lenders", path: "/borrower/lenders" },
    { name: "My Loans", path: "/borrower/my-loans" },
    { name: "Pricing", path: "/borrower/pricing" },
  ];
        ...
        <div className="lg:hidden fixed inset-0 z-[60] flex">
          ...
          <div className="relative w-[90%] sm:w-[85%] max-w-sm h-full bg-black/90 border-r border-white/10 shadow-2xl flex flex-col animate-in slide-in-from-left duration-300">
            ...
            <div className="flex-1 overflow-y-auto px-4 py-6 space-y-6">
              ...
              <div className="flex flex-col gap-3 pt-4 border-t border-white/10 mt-auto scale-95 origin-left">
                <ProfileDropdown />
              </div>
            </div>
          </div>
